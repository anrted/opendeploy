...
const route=useRoute(),router=useRouter(),server=ref(null),loading=ref(true),errorMessage=ref(''),tasks=ref([]),events=ref([]),heartbeats=ref([]),tab=ref('tasks'),enrollment=ref(null),showAgentUpdate=ref(false)
